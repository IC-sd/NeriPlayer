...
整合 **网易云音乐**、**Bilibili**、**YouTube Music** 与 **酷狗音乐** 的在线内容，
...
- 🎧 **多源探索与播放**：
  支持网易云音乐、Bilibili、YouTube Music、酷狗音乐与本地音频播放。
- 🏠 **首页推荐与继续播放**：
...
- 🛠️ **开发者模式与调试工具**：
  ...
  包含 YouTube / Bili / Netease / Kugou / Search / Listen Together 探针、
  普通日志与崩溃日志查看器。
- 🛟 **安全模式与崩溃日志**：
...
|- **酷狗音乐**：
  歌曲搜索、歌单链接导入（支持 specialId / gcid）、歌单内搜索、歌曲封面显示、播放地址获取与直接播放；
  受限歌曲自动降级至其他平台播放。
|- **本地音频**：
